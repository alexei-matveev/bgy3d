...
("methanol, oplsaa"
 (("C" (-0.748 -0.015 0.024) 96) ;; "Alcohol CH3OH & RCH2OH"
  ("HC1" (-1.293 -0.202 -0.901) 95) ;;"Methanol CH3-"
  ("HC2" (-1.263 0.754 0.6) 95)
  ("HC3" (-0.699 -0.934 0.609) 95)
  ("O" (0.558 0.42 -0.278) 93) ;;"Alcohol -OH"
  ("OH" (0.716 1.404 0.137) 94))) ;;"Alcohol -OH", vdw parameters are
                                 ;; 0.0 in original database
("butanoic acid, oplsaa"
 (("C1" (1.422 -0.017 0.0) 206)  ;; "Carboxylic Acid -COOH"
  ("O1" (1.422 1.353 0.0) 208)   ;; FIXME: the descriptions in datafile
  ("O2" (2.643 -0.722 0.0) 207)  ;; of these two may need to be swapped
  ("C2" (0.1 -0.78 0.0) 78)      ;; "Alkane -CH2-"
  ("C3" (-1.06 0.212 0.0) 78)    ;; "Alkane -CH2-"
  ("C4" (-2.381 -0.551 0.0) 77)  ;; "Alkane CH3-"
  ("OH" (3.21 -0.461 0.882) 209) ;; "Carboxylic Acid -COOH", original
                                 ;; vdw parameters are 0.0
  ("H2" (0.043 -1.407 0.89) 82)  ;; "Alkane H-C"
  ("H3" (0.043 -1.407 -0.89) 82)
  ("H4" (-1.002 0.838 -0.89) 82)
  ("H5" (-1.002 0.838 0.89) 82)
  ("H6" (-2.439 -1.178 0.89) 82)
  ("H7" (-2.439 -1.178 -0.89) 82)
  ("H8" (-3.21 0.157 0.0) 82)))

("hexane, oplsaa"
 (("C" (1.709 -2.812 0.0) 77) ;; "Alkane CH3-"
  ("C" (1.684 -1.278 0.0) 78) ;; "Alkane -CH2-"
  ("C" (0.245 -0.753 0.0) 78)
  ("C" (0.241 0.779 0.0) 78)
  ("C" (-1.198 1.304 0.0) 78)
  ("C" (-1.206 2.834 0.0) 77)
  ("H" (2.236 -3.164 0.887) 82) ;; "Alkane H-C"
  ("H" (2.232 -3.164 -0.89) 82)
  ("H" (0.691 -3.204 0.003) 82)
  ("H" (2.202 -0.914 -0.888) 82)
  ("H" (2.201 -0.914 0.89) 82)
  ("H" (-0.273 -1.115 0.889) 82)
  ("H" (-0.272 -1.115 -0.89) 82)
  ("H" (0.757 1.142 -0.89) 82)
  ("H" (0.757 1.141 0.89) 82)
  ("H" (-1.716 0.944 0.89) 82)
  ("H" (-1.716 0.944 -0.89) 82)
  ("H" (-0.696 3.204 -0.89) 82)
  ("H" (-0.696 3.204 0.89) 82)
  ("H" (-2.236 3.19 0.0) 82)))
