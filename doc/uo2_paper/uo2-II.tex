...
\documentclass[english,journal=jpcafh,layout=twocolumn,maxauthors=0]{achemso}
...
field of a charged solute, Section~\ref{sec:methodology}. Then we
validate the implementation by comparing the results of 1D and 3D
techniques for alkali and halide ions, Section~\ref{sec:simple-ions}.
...
($n=4-6$), using a force field description, Section~\ref{sub:MM+RISM},
and a quantum mechanical representation of the interactions within
the first solvation shell, Section~\ref{sub:QM+RISM}. We also compare
...
shell, Section~\ref{sub:water-exchange}, using QM and MM models
...
\citep{ParaGaussV3.2}.  The atomic approximation \citep{Matveev08}
...
\centering{}\includegraphics[width=1\linewidth]{uo2-II\lyxdot d/4w-composite}
\end{figure}
\begin{table}[tbph]
...
\centering{}\includegraphics[width=1\linewidth]{uo2-II\lyxdot d/fig2}
\end{figure}
...
\centering{}\includegraphics[width=1\linewidth]{uo2-II\lyxdot d/fig3}
\end{figure}
...
represents the MD result of Ref.~\citep{Bo15}\textcolor{blue}{.}
...
\centering{}\includegraphics[width=1\linewidth]{uo2-II\lyxdot d/pmf}
\end{figure}
...
\centering{}\includegraphics[width=1\linewidth]{uo2-II\lyxdot d/pmf-2d}
\end{figure}
...
The QM model and ``hard'' force field model predict the six-coordinated
...
We thank \textcolor{blue}{Prof.~H.-J.~Bungartz, his co-workers,
...
\begin{tocentry}
\includegraphics[height=3.5cm]{uo2-II.d/4w-composite}
\end{tocentry}
\end{document}
