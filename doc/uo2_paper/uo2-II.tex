...
40\%. \hlc[green]{With the same computing equipment, a comparable 1D-RISM calculation takes about 10 seconds.} The non-linear solver converges in 8 iterations with about 380
...
aqua ligands: U--O$_{\text{w}}$ (top panel, \hlc[green]{red}), U--H$_{\text{w}}$
(top panel, \hlc[green]{blue}), O--O$_{\text{w}}$ (bottom panel, \hlc[green]{red}) and O--H$\text{\ensuremath{_{w}}}$ (bottom panel, \hlc[green]{blue}). Results obtained with the PSE1 closure are shown
as \hlc[green]{solid lines}, results obtained with the closure relations PSE2 and PSE3 are displayed \hlc[green]{using dashed lines and dotted lines respectively}.  \label{fig:rdfs-vs-closure-0w}}
...
PSE2 and PSE3, \hlc[green]{are displayed as solid, dashed and dot-dashed lines respectively}. The \hlc[green]{dotted} line
