...
\title{\hlc[green]{Uranyl Solvation by a Three-Dimensional Reference Interaction Site
Model}}
...
40\%. \hlc[green]{With the same computing equipment, a comparable
1D-RISM calculation takes about 10 seconds.} The non-linear solver
converges in 8 iterations with about 380 Jacobian applications.
...
calculated by Eq.~\ref{eq:dG-sol-definition}, is by about \hlc[green]{5~kcal/mol}
...
to compare PCM and RISM representations of the solvent in QM
calculations.  \hlc[cyan]{The symmetry constraints for the five- and
  six-coordinated uranyl are qualitatively consistent with the
  structures obtained by unconstrained optimization (see next
  section). However, the under-coordinated species does not feature a
  vacancy in the first solvation shell as in an unconstrained
  structure. Instead, all water ligands are evenly distributed in the
  equatorial plane.}  These models feature an additional
intra-molecular degree of freedom, the uranyl bond length, in contrast
to the MM models discussed in the previous section where the uranyl
...
\caption{Radial distribution functions of solvated uranyl without
  explicit aqua ligands: U--O$_{\text{w}}$ (top panel,
  \hlc[green]{red}), U--H$_{\text{w}}$ (top panel, \hlc[green]{blue}),
  O--O$_{\text{w}}$ (bottom panel, \hlc[green]{red}) and
  O--H$\text{\ensuremath{_{w}}}$ (bottom panel,
  \hlc[green]{blue}). Results obtained with the PSE1 closure are shown
  as \hlc[green]{solid lines}, results obtained with the closure
  relations PSE2 and PSE3 are displayed \hlc[green]{using dashed lines
    and dotted lines respectively}.  \label{fig:rdfs-vs-closure-0w}}
...
\caption{Potential of mean force, $W(r)$, from the U--O$_{\text{w}}$
  radial distribution function, determined with the closure relations
  PSE1, PSE2 and PSE3, \hlc[green]{are displayed as solid, dashed and
  dot-dashed lines, respectively}. The \hlc[green]{dotted} line
