...
\address[tum]{Department Chemie, Technische Universität München, 85747 Garching,
Germany}


\address[crc]{Catalysis Research Center, Technische Universität München, 85747
Garching, Germany}
\begin{abstract}
...
addition of a Lennard--Jones (LJ) term for hydrogen atoms with $\sigma_{\text{H}}=0.4$~Å
...
points in total and a cubic box volume of $20^{3}$~Å$^{3}$ we are
...
used. 3D domain is $20^{3}$ Å$^{3}$ / $64^{3}$ pts. $^{b}$~1D
...
the thermodynamic sampling is also estimated by Bühl et.\ al \citep{Buehl06b}
